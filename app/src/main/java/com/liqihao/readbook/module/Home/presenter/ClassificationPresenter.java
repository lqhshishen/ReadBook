...
public class ClassificationPresenter extends AppPresenter<ClassificationFragment> implements ClassificationContract.Presenter {

    public List<ClassificationBean.result> data;

    @Inject
    public ClassificationPresenter(ClassificationFragment classificationFragment,BookApi bookApi) {
